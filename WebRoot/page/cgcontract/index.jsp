...
<body>
	<div class="main-container" id="main-container">
			...
			<form class="form-horizontal" role="form">
				...
				<div class="col-xs-4">
					<!-- PAGE CONTENT BEGINS -->
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="cgcontractnum">合同编号</label>

							<div class="col-sm-9">
								<input type="text" id="cgcontractnum" placeholder="合同编号"  class="col-xs-12"/>
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="fkSuppliersno">供应商</label>

							<div class="col-sm-9">
								<input type="text" id="fkSuppliersno" placeholder="供应商"  class="col-xs-12"/>
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="fkUsecompno">签订单位</label>

							<div class="col-sm-9">
								<input type="text" id="fkUsecompno" placeholder="签订单位"  class="col-xs-12"/>
							</div>
						</div>
				</div>
				<div class="col-xs-4">
					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="cgcontractname">合同名称</label>

						<div class="col-sm-9">
							<input type="text" id="cgcontractname" placeholder="合同名称" class="col-xs-12"/>
						</div>
					</div>
					<div class="form-group">
				...
				<div class="col-xs-4">
					...
					<div class="form-group">
						<label for="arrivaldate" class="col-sm-3 control-label">到货日期</label>
						<div class="col-sm-9">
							<div class="input-group">
								<input class="date-picker col-xs-12" id="arrivaldate" type="text" data-date-format="yyyy-mm-dd" />
								<span class="input-group-addon"> 
								<i class="icon-calendar bigger-110"></i>
								</span>
							</div>
	...
	<script type="text/javascript">
		jQuery(function($) {
				...
				jQuery(modalgrid_selector).jqGrid({
					//direction: "rtl",
					url: '<%=path%>/plan/plan_cgContractPlan.action',
					datatype: "json",
					cellEdit:false,
					mtype: 'POST',
					height: parentMainHeight-420,
	...
	<script type="text/javascript">
			...
			var doAddContract = function(){
				...
				var url = "<%=path%>/cgcontract/cgcontract_save.action";
				$.ajax({
					url:url,
					data:{
						"nos":params,
						"cgcontract.cgcontractnum":$("#cgcontractnum").val(),
						"cgcontract.cgcontractname":$("#cgcontractname").val(),
						"cgcontract.fkSuppliersno":$("#fkSuppliersno").val(),
						"cgcontract.totalmoney":$("#totalmoney").val(),
						"cgcontract.signingdate":$("#signingdate").val().replace(/-/gm,""),
						"cgcontract.arrivaldate":$("#arrivaldate").val().replace(/-/gm,""),
						"cgcontract.qualitydate":$("#qualitydate").val().replace(/-/gm,""),
						"cgcontract.qualitymoney":$("#qualitymoney").val(),
						//"cgcontract.payed":$("#payed").val(),
						"cgcontract.fkUsecompno":$("#fkUsecompno").val()
