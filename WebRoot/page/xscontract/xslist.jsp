	...
	<body>
		...
		jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					url: '<%=path%>/xscontract/xscontract_findByPager.action',
					datatype: "json",
					//datatype: "local",
					//data: grid_data,
					cellEdit:false,
					...
					colNames:[' ','合同号','合同名称','合同金额', '签订日期', '提报单位', '费率','开票金额','已收金额','应收金额','质保金额','质保日期','签订单位','cgcontractno','invalid'],
					colModel:[
						{name:'cgcontractno',index:'', width:70, fixed:true, resize:false,
							...
							formatoptions:{
								...
								delOptions:{
									...
									url:'<%=path%>/xscontract/xscontract_delete.action',
									mtype:'POST',
									delData:{"nos":getNo}
								},
								//editformbutton:true,
								editOptions:{
									...
									url:'<%=path%>/xscontract/xscontract_save.action',
									mtype:'POST'
								},
								extraparam: {
									"plan.planno":getNo,
						...
						{name:'xscontractnum',index:'xscontractnum', width:110},
						{name:'xscontractname',index:'xscontractname',editable: true,width:100},
						...
						{name:'salesrate',index:'salesrate',width:80, sorttype:"int",width:50,editable: true},
						{name:'billingMoney',index:'billingMoney', sorttype:"int",width:80,editable: true},
						{name:'receivedMoney',index:'receivedMoney', width:80,editable: true,sorttype:"int"},
						{name:'shuldReceived',index:'shuldReceived',width:80,editable: true,sorttype:"int"},
						...
						{name:'signcomp',index:'signcomp', width:100,editable: true},
						{name:'xscontractno',hidden:true},
					...
					scroll:1,//滚动加载
					editurl: "<%=path%>/xscontract/xscontract_save.action",
					caption: "销售合同管理",
					shrinkToFit:false,
					autowidth: true
