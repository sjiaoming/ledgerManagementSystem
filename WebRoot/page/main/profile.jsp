						...
						<div class="col-xs-12 col-sm-3 center">
							<div>
								<span class="profile-picture"> <img id="avatar"
									...
									src="<%=path %>/page/upload/${user.userno }.jpg" />
								</span>
								...
								<div
									...
									<div class="inline position-relative">
										<a href="javascript:void(0)" class="user-title-label dropdown-toggle"
											...
											class="white">${user.username }</span>
										</a>
							...
							<div class="profile-user-info profile-user-info-striped">
								<div class="profile-info-row">
									...
									<div class="profile-info-value">
										<span class="editable" id=""> ${user.username }</span>&nbsp;
									</div>
								</div>
								<div class="profile-info-row">
									...
									<div class="profile-info-value">
										<span class="editable" id=""> ${user.personname }</span>&nbsp;
									</div>
								</div>
								<div class="profile-info-row">
								...
								<div class="profile-info-row">
									...
									<div class="profile-info-value">
										<span class="editable" id="">${user.createtime }</span>&nbsp;
									</div>
								</div>
