...
<html lang="en">
<head>
<title>神华国内采购中心LMS</title>
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<script src="<%=path %>/webres/assets/jquery.min.js"></script>
...
<body>
				...
				<ul class="nav ace-nav">
					...
					<li class="light-blue"><a data-toggle="dropdown" href="#"
						class="dropdown-toggle"> <img class="nav-user-photo"
							src="<%=path %>/webres/assets/avatars/user.jpg" alt="Jason's Photo" /> <span
						...
						<ul
							...
							<li><a href="<%=path %>/page/main/profile.jsp"  target="mainframe"> <i class="icon-user"></i> 个人资料
							</a></li>

							<li class="divider"></li>

							<li><a href="<%=path %>/user/user_logout.action"> <i class="icon-off"></i> 退出
							</a></li>
						</ul></li>
				</ul>
				<!-- /.ace-nav -->
	...
	<div class="main-container" id="main-container">
		...
		<div class="main-container-inner">
			...
			<div class="main-content" id="mains">
				<iframe id="mainframe" name="mainframe" src="<%=path %>/page/main/profile.jsp"
	...
	<script type="text/javascript">
		if ("ontouchend" in document)
			document.write("<script src='"+<%=path %>+"/webres/assets/js/jquery.mobile.custom.min.js'><script>");
	</script>
	...
	<script src="<%=path %>/webres/assets/js/jquery.slimscroll.min.js"></script>
	<script src="<%=path %>/webres/assets/js/jquery.easy-pie-chart.min.js"></script>
	<script src="<%=path %>/webres/assets/js/jquery.sparkline.min.js"></script>
	<script src="<%=path %>/webres/assets/js/flot/jquery.flot.min.js"></script>
	<script src="<%=path %>/webres/assets/js/flot/jquery.flot.pie.min.js"></script>
	<script src="<%=path %>/webres/assets/js/flot/jquery.flot.resize.min.js"></script>
